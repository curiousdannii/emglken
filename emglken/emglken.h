...
extern void glem_fileref_create_by_name(glui32 usage, char *name, glui32 rock, glui32 *tagptr);
extern void glem_fileref_create_by_prompt(glui32 usage, glui32 fmode, glui32 rock, glui32 *tagptr);
extern void glem_fileref_create_from_fileref(glui32 usage, glui32 oldtag, glui32 rock, glui32 *tagptr);
extern void glem_fileref_create_temp(glui32 usage, glui32 rock, glui32 *tagptr);
extern void glem_fileref_destroy(glui32 tag);
extern glui32 glem_get_window_echostream_tag(glui32 wintag);
extern void glem_new_window(glui32 split, glui32 method, glui32 size, glui32 wintype, glui32 rock, glui32 *wintagptr, glui32 *strtagptr, glui32 *pairwintag);
...
extern void glem_stream_open_file(glui32 tag, glui32 fmode, glui32 rock, int unicode, glui32 *tagptr);
extern void glem_stream_open_memory(void *buf, glui32 buflen, glui32 fmode, glui32 rock, int unicode, glui32 *tagptr);
extern void glem_stream_open_resource(glui32 filenum, glui32 rock, int unicode, glui32 *tagptr);
